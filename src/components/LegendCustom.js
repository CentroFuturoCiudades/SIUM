...
export const LegendCustom = ({ title, info1, color, title2, legendItems }) => {
  ...
  return (
    ...
    >
      <div style={{ width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'left', marginBottom: '0px', marginTop: '5px' }}>
      ...
      <div style={{ alignItems: 'center' }}>
        ...
        <Heading size="xs" color="gray.700">{title2}</Heading>
      </div>
      {legendItems.map((item, index) => (
        <div key={index} style={{ display: 'flex', alignItems: 'center'}}>
            ...
            <div className="legend-numbers">
                <span className="legend-label" style={{whiteSpace: 'nowrap'}}>{item.item1}:</span>
